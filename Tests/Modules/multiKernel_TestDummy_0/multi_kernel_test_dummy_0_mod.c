 ...
 * 
 * @file multi_kernel_test_dummy_0_mod.c
 * @author Samu
 */
...
#include "multi_kernel_test_dummy_0_mod.h"
#include "oe_kernel.h"
...
static module_multiKernel_TestDummy_0_t *multiKernel_TestDummy_0;

//~~~~~~~~~~~~~~~~~~~~~~~~ Custom init prototype ~~~~~~~~~~~~~~~~~~~~~~~~//

/**
 * @brief Custom initializer for the module: multiKernel_TestDummy_0.
 * 
 ...
 */
static inline OE_Error_t init_multiKernel_TestDummy_0(void *Args);
...
OE_Error_t initModule_multiKernel_TestDummy_0(
    module_multiKernel_TestDummy_0_t *pmultiKernel_TestDummy_0,
    void *Args,
    OE_Kernel_t *Kernel)
{
    OE_Error_t Error;
    ...
    multiKernel_TestDummy_0 = pmultiKernel_TestDummy_0;
    multiKernel_TestDummy_0->Kernel = Kernel;

    /* Initialize the module. */
    Error = init_multiKernel_TestDummy_0(Args);

    /* Check for errors. */
    if (Error != OE_ERROR_NONE)
    {
        multiKernel_TestDummy_0->Kernel = NULL;
        multiKernel_TestDummy_0 = NULL;
...
OE_Error_t init_multiKernel_TestDummy_0(void *Args)
{
