 ...
 * 
 * @file multi_kernel_test_dummy_2_mod.c
 * @author Samu
 */
...
#include "multi_kernel_test_dummy_2_mod.h"
#include "oe_kernel.h"
...
static module_multiKernel_TestDummy_2_t *multiKernel_TestDummy_2;

//~~~~~~~~~~~~~~~~~~~~~~~~ Custom init prototype ~~~~~~~~~~~~~~~~~~~~~~~~//

/**
 * @brief Custom initializer for the module: multiKernel_TestDummy_2.
 * 
 ...
 */
static inline OE_Error_t init_multiKernel_TestDummy_2(void *Args);
...
OE_Error_t initModule_multiKernel_TestDummy_2(
    module_multiKernel_TestDummy_2_t *pmultiKernel_TestDummy_2,
    void *Args,
    OE_Kernel_t *Kernel)
{
    OE_Error_t Error;
    ...
    multiKernel_TestDummy_2 = pmultiKernel_TestDummy_2;
    multiKernel_TestDummy_2->Kernel = Kernel;

    /* Initialize the module. */
    Error = init_multiKernel_TestDummy_2(Args);

    /* Check for errors. */
    if (Error != OE_ERROR_NONE)
    {
        multiKernel_TestDummy_2->Kernel = NULL;
        multiKernel_TestDummy_2 = NULL;
...
OE_Error_t init_multiKernel_TestDummy_2(void *Args)
{
