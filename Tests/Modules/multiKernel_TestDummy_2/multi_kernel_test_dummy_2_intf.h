 ...
 * 
 * @file multi_kernel_test_dummy_2_intf.h
 * @author Samu
 */
...
#ifndef MULTI_KERNEL_TEST_DUMMY_2_INTF_H
#define MULTI_KERNEL_TEST_DUMMY_2_INTF_H
...
#endif // MULTI_KERNEL_TEST_DUMMY_2_INTF_H